...
<form method="post" action="BookAppointmentServlet">
    <label>Enter Patient Full NAME (registered patient only)</label>
    <input type="text" name="searchQuery" placeholder="Enter patient name or ID" required>

    <label>Disease:</label>
    <input type="text" name="disease" required>

    <label>Department:</label>
    <select name="department" id="department" onchange="fetchDoctorsByDepartment()" required>
    ...
    <input type="submit" id="submitBtn" value="Book Appointment" disabled>
</form>
